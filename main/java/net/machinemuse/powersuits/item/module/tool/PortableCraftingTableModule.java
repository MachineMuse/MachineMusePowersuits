...
public class PortableCraftingTableModule extends PowerModuleBase implements IRightClickModule {
    public PortableCraftingTableModule(String resourceDommain, String UnlocalizedName) {
