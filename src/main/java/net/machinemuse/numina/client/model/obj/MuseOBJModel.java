...
public class MuseOBJModel implements IModel {
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        ...
        return new MuseOBJBakedModel(this, state, format, builder.build());
    }
                ...
                try {
                    ...
                    if (key.equalsIgnoreCase("mtllib")) {
                        ...
                        if (this.materialLibrary.materials.containsKey(data)) {
                            ...
                            FMLLog.log.error("MuseOBJModel.Parser: (Model: '{}', Line: {}) material '{}' referenced but was not found", objFrom, lineNum, data);
                        }
                        usemtlCounter++;
            ...
            for (; ; ) {
                ...
                if (key.equalsIgnoreCase("newmtl")) {
                    ...
                    if (key.equalsIgnoreCase("Kd") || !hasSetColor) {
                        ...
                        FMLLog.log.info("MuseOBJModel: A color has already been defined for material '{}' in '{}'. The color defined by key '{}' will not be applied!", material.getName(), new ResourceLocation(domain, path).toString(), key);
                    }
                    ...
                    if (key.equalsIgnoreCase("map_Kd") || !hasSetTexture) {
                        ...
                        FMLLog.log.info("MuseOBJModel: A texture has already been defined for material '{}' in '{}'. The texture defined by key '{}' will not be applied!", material.getName(), new ResourceLocation(domain, path).toString(), key);
                    }
