package net.machinemuse.numina.utils.player;
...
public class MusePlayerUtils {
    ...
    public static RayTraceResult raytraceEntities(World world, EntityPlayer player, boolean collisionFlag, double reachDistance) {
        ...
        // player.boundingBox.addCoord(playerLook.x * reachDistance,
        // playerLook.y * reachDistance, playerLook.zCoord
        // * reachDistance);
    ...
    public static double getPlayerCoolingBasedOnMaterial(EntityPlayer player) {
        ...
        cool += ((2.0 - getBiome(player).getTemperature(new BlockPos((int)player.posX, (int)player.posY, (int)player.posZ))/2)); // Algorithm that returns a value from 0.0 -> 1.0. Biome temperature is from 0.0 -> 2.0
