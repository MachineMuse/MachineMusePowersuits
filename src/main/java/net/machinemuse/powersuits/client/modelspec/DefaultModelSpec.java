...
import static net.machinemuse.powersuits.client.modelspec.MorphTarget.*;
...
public class DefaultModelSpec {
    ...
    public static ModelSpec[] loadDefaultModel() {
        ...
        /* Head ----------------------- */
        ModelSpec headModel = loadModel(new ResourceLocation("powersuits:models/item/armormps_helm.obj"));
        ...
        /* Arms ----------------------- */
        ModelSpec armsModel = loadModel(new ResourceLocation("powersuits:models/item/armormps_arms.obj"));
        ...
        /* Body ----------------------- */
        ModelSpec bodyModel = loadModel(new ResourceLocation("powersuits:models/item/armormps_chest.obj"));
        ...
        /* Legs ----------------------- */
        ModelSpec legsModel = loadModel(new ResourceLocation("powersuits:models/item/armormps_pantaloons.obj"));
        ...
        /* Feet ----------------------- */
        ModelSpec feetModel = loadModel(new ResourceLocation("powersuits:models/item/armormps_boots.obj"));
