...
//        this.registerModels = registerModelsIn;
    ...
    public void parseModel(Node modelnode) {
        ...
        if (modelnode.getNodeType() == Node.ELEMENT_NODE) {
            ...
            texturesArray = Arrays.asList(eElement.getAttribute("textures").split(","));
            TextureAtlasSprite texture;
            for (String textureLocation: texturesArray) {

                System.out.println("texture location: ");

                Minecraft.getMinecraft().getTextureMapBlocks().registerSprite(new ResourceLocation(textureLocation));
            }
