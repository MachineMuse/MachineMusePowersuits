...
//public class ModelLuxCapacitorOLD implements IBakedModel {
...
//
//    public ModelLuxCapacitorOLD(IBakedModel bakedModelIn) {
...
//            matrix = (baseFrameModel).handlePerspective(cameraTransformTypeIn).getValue();
//        } else {
