...
//    }
//    // item model variant
//    public static final ModelResourceLocation luxCapItemLocation = new ModelResourceLocation(BlockLuxCapacitor.getInstance().getRegistryName(), "inventory");
//    private static final ResourceLocation lensModelLocation = new ResourceLocation(MODID, "models/block/luxcapacitor/lightCore.obj");
...
//        return new ModelResourceLocation(BlockLuxCapacitor.getInstance().getRegistryName(), "facing=" + facing.getName());
//    }
//
...
//        else color = ((IExtendedBlockState) state).getValue(BlockLuxCapacitor.COLOUR);
...
//                state = BlockLuxCapacitor.getInstance().getDefaultState().withProperty(FACING, EnumFacing.DOWN);
...
//                    state = BlockLuxCapacitor.getInstance().getDefaultState().withProperty(FACING, side);
//                    lensList = lensModel.getQuads(state, null, 0);
//                    lensList= ModelHelper.getColoredQuads(lensList, color);
//                    frameList = frameModel.getQuads(state, null, 0);
//
...
//        return Minecraft.getMinecraft().getTextureMapBlocks().registerSprite(new ResourceLocation(RESOURCE_PREFIX, "blocks/LuxCap"));
//    }
//}