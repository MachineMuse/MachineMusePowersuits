...
public class MuseIcon {
    private static MuseIcon ourInstance;
    private MuseIcon() {
    }
    public static MuseIcon getInstance() {
        if (ourInstance == null)
            ourInstance = new MuseIcon();
        return ourInstance;
    }
...
//    public static Map<TextureAtlasSprite, String> itemModelTextures = new HashMap<>();

    public static BiMap<String, TextureAtlasSprite> itemModelTextures = HashBiMap.create();

    public static void addItemModelTextureToList(TextureAtlasSprite sprite, String location) {
        if (!itemModelTextures.containsKey(location))
            itemModelTextures.put(location, sprite);
    }
    ...
    @SideOnly(Side.CLIENT)
    @SubscribeEvent
    public static void registerIcons(TextureStitchEvent event) {
        /* Armor -------------------------------------------------------------------------------------- */
        ...
        System.out.println("basicplating: " + basicPlating.toString());
    ...
    private static TextureAtlasSprite register(TextureStitchEvent event, String location) {
//        return event.getMap().registerSprite(new ResourceLocation(MODID, "textures/" + location + ".png"));
        return event.getMap().registerSprite(new ResourceLocation(MODID, location ));
    }
}