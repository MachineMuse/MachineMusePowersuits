...
import static net.machinemuse.powersuits.common.Config.RESOURCE_PREFIX;
...
//                }
                ...
                List<BakedQuad> getBaseQuads(@Nullable EnumFacing facing) {
                    ...
                    return bakedModel.getQuads(MPSItems.luxCapacitor.getDefaultState().withProperty(BlockDirectional.FACING, facing), null, 0);
                }
                ...
                List<BakedQuad> getLensColoredQuads(Colour color, @Nullable EnumFacing facing) {
                    ...
                    List<BakedQuad> quads = bakedModel.getQuads(MPSItems.luxCapacitor.getDefaultState().withProperty(BlockDirectional.FACING, facing), null, 0);
