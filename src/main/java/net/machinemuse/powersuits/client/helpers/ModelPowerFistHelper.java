...
public class ModelPowerFistHelper {
    public static final ResourceLocation powerFistLocation = new ResourceLocation(MODID, "models/item/powerFist/powerFist.obj");
    public static final ResourceLocation powerFistFingersNormalLocation = new ResourceLocation(MODID, "models/item/powerFist/powerFistFingersNormal.obj");
    public static final ResourceLocation powerFistFingersFiringLocation = new ResourceLocation(MODID, "models/item/powerFist/powerFistFingersFiring.obj");

    public static final ResourceLocation powerFistLeftLocation = new ResourceLocation(MODID, "models/item/powerFist/powerFistLeft.obj");
    public static final ResourceLocation powerFistFingersLeftNormalLocation = new ResourceLocation(MODID, "models/item/powerFist/powerFistFingersNormalLeft.obj");
    public static final ResourceLocation powerFistFingersLeftFiringLocation = new ResourceLocation(MODID, "models/item/powerFist/powerFistFingersFiringLeft.obj");
