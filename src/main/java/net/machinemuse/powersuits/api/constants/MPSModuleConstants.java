...
public class MPSModuleConstants {
    ...
    public static final String JETBOOTS_ENERGY_CONSUMPTION = "Jetboots Energy Consumption";
    public static final String JETBOOTS_THRUST = "Jetboots Thrust";
    public static final String JETPACK_ENERGY_CONSUMPTION = "Jetpack Energy Consumption";
    public static final String JETPACK_THRUST = "Jetpack Thrust";
    ...
    public static final String SHEARING_ENERGY_CONSUMPTION = "Shearing Energy Consumption";
    public static final String SHEARING_HARVEST_SPEED = "Shearing Harvest Speed";
    ...
    public static final String HEAT_EMISSION = "Heat Emission";
