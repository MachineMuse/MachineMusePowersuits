...
public class MusePacketColourInfo extends MusePacket {
    ...
    public MusePacketColourInfo(EntityPlayer player, int itemSlot, byte[] tagData) {
        this.player = player;
    ...
    public void handleServer(EntityPlayerMP player) {
        ...
        if (stack != null && stack.getItem() instanceof IModularItem) {
            ...
            renderTag.setByteArray("colours", tagData);
        }
    }
    ...
    public static class MusePacketColourInfoPackager extends MusePackager {
        ...
        public MusePacket read(DataInputStream datain, EntityPlayer player) {
            ...
            byte[] tagData = readByteArray(datain);
