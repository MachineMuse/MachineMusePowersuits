...
import net.machinemuse.powersuits.item.module.weapon.BladeLauncherModule;
    ...
    public EntitySpinningBlade(World par1World, EntityLivingBase shootingEntity) {
        ...
        if (shootingEntity instanceof EntityPlayer) {
            ...
            if (this.shootingItem != null) {
                this.damage = ModuleManager.getInstance().computeModularPropertyDouble(shootingItem, BladeLauncherModule.BLADE_DAMAGE);
            }
        }
