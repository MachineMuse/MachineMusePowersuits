...
public class MPSSettings {
    ...
    public static class Modules {
        ...
        public Map<String, Double> propertyDouble = new HashMap<String, Double>() {{
            ...
            put("advSolarGenerator.Slot Points.base", 1.0D);
            put("advancedBattery.Maximum Energy.base", 5000000.0D);
            ...
            put("advancedCoolingSystem.Slot Points.base", 1.0D);
            put("apiaristArmor.Apiarist Armor Energy Consumption.base", 100.0D);
            put("apiaristArmor.Slot Points.base", 1.0D);
            put("appengECWirelessFluid.Slot Points.base", 1.0D);
            put("appengWireless.Slot Points.base", 1.0D);
            put("aquaAffinity.Slot Points.base", 1.0D);
            ...
            put("aurameter.Slot Points.base", 1.0D);
            ...
            put("axe.Slot Points.base", 1.0D);
            put("basicBattery.Maximum Energy.base", 1000000.0D);
            ...
            put("basicCoolingSystem.Slot Points.base", 1.0D);
            put("binoculars.Field of View.FOV multiplier.multiplier", 9.5D);
            put("binoculars.Field of View.base", 0.5D);
            put("binoculars.Slot Points.base", 1.0D);
            put("bladeLauncher.Slot Points.base", 1.0D);
            ...
            put("blinkDrive.Slot Points.base", 1.0D);
            put("chisel.CHISEL Energy Consumption.Overclock.multiplier", 9500.0D);
            put("chisel.CHISEL Energy Consumption.base", 500.0D);
            put("chisel.CHISEL Harvest Speed.Overclock.multiplier", 22.0D);
            put("chisel.CHISEL Harvest Speed.base", 8.0D);
            put("chisel.Slot Points.base", 1.0D);
            put("climbAssist.Slot Points.base", 1.0D);
            put("clock.Slot Points.base", 1.0D);
            put("compass.Slot Points.base", 1.0D);
            put("diamondPickUpgrade.Slot Points.base", 1.0D);
            put("diamondPlating.Armor (Physical).base", 5.0D);
            put("diamondPlating.Maximum Heat.base", 400.0D);
            ...
            put("hoe.Slot Points.base", 1.0D);
            put("invisibility.Slot Points.base", 1.0D);
            put("ironPlating.Armor (Physical).base", 4.0D);
            put("ironPlating.Maximum Heat.base", 300.0D);
            ...
            put("kineticGenerator.Movement Resistance.Energy Generated.multiplier", 0.5D);
            put("kineticGenerator.Movement Resistance.base", 0.0D);
            ...
            put("leafBlower.Slot Points.base", 1.0D);
            put("leatherPlating.Armor (Physical).base", 3.0D);
            put("leatherPlating.Maximum Heat.base", 75.0D);
            ...
            put("lightningSummoner.Slot Points.base", 1.0D);
            ...
            put("luxCapacitor.Slot Points.base", 1.0D);
            put("madModule.Slot Points.base", 1.0D);
            ...
            put("meleeAssist.Slot Points.base", 1.0D);
            put("mobRepulsor.Repulsor Energy Consumption.base", 2500.0D);
            put("mobRepulsor.Slot Points.base", 1.0D);
            put("nightVision.Slot Points.base", 1.0D);
            put("omniProbe.Slot Points.base", 1.0D);
            put("omniwrench.Slot Points.base", 1.0D);
            put("oreScanner.Slot Points.base", 1.0D);
            put("parachute.Slot Points.base", 1.0D);
            ...
            put("pickaxe.Slot Points.base", 1.0D);
            ...
            put("plasmaCannon.Slot Points.base", 1.0D);
            put("portableCraftingTable.Slot Points.base", 1.0D);
            ...
            put("shovel.Slot Points.base", 1.0D);
            put("silk_touch.Slot Points.base", 1.0D);
            put("solarGenerator.Daytime Energy Generation.base", 15000.0D);
            put("solarGenerator.Nighttime Energy Generation.base", 1500.0D);
            put("solarGenerator.Slot Points.base", 1.0D);
            put("sprintAssist.Slot Points.base", 1.0D);
