 ...
 */
public class ItemModuleRefinedStorageWireless extends ItemAbstractPowerModule implements IRightClickModule {
    ...
    public ItemModuleRefinedStorageWireless(String regName) {
