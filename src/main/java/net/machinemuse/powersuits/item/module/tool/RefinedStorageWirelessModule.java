...
//    public static ItemStack emulatedTool;
    ...
    public RefinedStorageWirelessModule(String resourceDommain, String UnlocalizedName) {
...
//            emulatedTool = new ItemStack( Item.REGISTRY.getObject(wirelessGridRegName), 1, 0);
    ...
    public ActionResult onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand) {
        ...
        if (tag != null) {
            ...
            int energyUsed = (int) ((energy - emulatedTool.getTagCompound().getInteger("Energy")) * ModCompatibility.getRSRatio());
