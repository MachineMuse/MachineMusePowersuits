...
import net.machinemuse.powersuits.utils.module.helpers.OmniProbeHelper;
...
//    private ItemStack teMultimeter;
    ...
    public OmniProbeModule(String resourceDommain, String UnlocalizedName) {
    ...
    public void onPlayerTickActive(EntityPlayer player, ItemStack item) {
        if (!OmniProbeHelper.getEIOFacadeTransparency(item)) {
            OmniProbeHelper.setEIONoCompete(item, MPSModuleConstants.MODULE_OMNIPROBE);
    ...
    public void onPlayerTickInactive(EntityPlayer player, ItemStack item) {
        if ((OmniProbeHelper.getEIONoCompete(item) != null) && (!OmniProbeHelper.getEIONoCompete(item).isEmpty())) {
            if (OmniProbeHelper.getEIONoCompete(item).equals(MPSModuleConstants.MODULE_OMNIPROBE)) {
