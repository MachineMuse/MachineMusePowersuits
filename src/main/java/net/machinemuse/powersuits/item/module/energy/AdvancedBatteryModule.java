...
public class AdvancedBatteryModule extends PowerModuleBase implements IMuseElectricItem {
    public AdvancedBatteryModule(String resourceDommain, String UnlocalizedName) {
...
//        addBasePropertyDouble(ElectricItemUtils.MAXIMUM_ENERGY, 100000, "J");
//        addBasePropertyDouble(MPSModuleConstants.WEIGHT, 2000, "g");
//        addTradeoffPropertyDouble("Battery Size", ElectricItemUtils.MAXIMUM_ENERGY, 400000);
