...
import net.machinemuse_old.numina.common.Numina;
import net.machinemuse_old.numina.general.MuseLogger;
import net.machinemuse_old.powersuits.common.proxy.CommonProxy;
import net.machinemuse_old.powersuits.powermodule.armor.*;
import net.machinemuse_old.powersuits.powermodule.cosmetic.*;
import net.machinemuse_old.powersuits.powermodule.energy.*;
import net.machinemuse_old.powersuits.powermodule.misc.*;
import net.machinemuse_old.powersuits.powermodule.movement.*;
import net.machinemuse_old.powersuits.powermodule.tool.*;
import net.machinemuse_old.powersuits.powermodule.weapon.*;
import net.machinemuse_old.utils.MuseStringUtils;
...
//        addModule(new TintModule(TOOLONLY));
    ...
    public static void setConfigFolderBase(File folder) {
        configFolder = new File(folder.getAbsolutePath() + "/machinemuse_old");
    }
