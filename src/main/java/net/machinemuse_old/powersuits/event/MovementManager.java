...
import net.machinemuse_old.powersuits.powermodule.movement.JumpAssistModule;
import net.machinemuse_old.powersuits.powermodule.movement.ShockAbsorberModule;
