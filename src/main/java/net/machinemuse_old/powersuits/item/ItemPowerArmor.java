...
import net.machinemuse_old.api.ApiaristArmor;
import net.machinemuse_old.api.IArmorTraits;
import net.machinemuse_old.api.ModuleManager;
import net.machinemuse_old.numina.geometry.Colour;
import net.machinemuse_old.powersuits.client.render.item.ArmorModelInstance;
import net.machinemuse_old.powersuits.client.render.item.IArmorModel;
import net.machinemuse_old.powersuits.common.Config;
import net.machinemuse_old.powersuits.powermodule.cosmetic.CitizenJoeStyle;
import net.machinemuse_old.powersuits.powermodule.cosmetic.HighPolyArmor;
import net.machinemuse_old.powersuits.powermodule.cosmetic.TintModule;
import net.machinemuse_old.powersuits.powermodule.cosmetic.TransparentArmorModule;
import net.machinemuse_old.powersuits.powermodule.misc.InvisibilityModule;
