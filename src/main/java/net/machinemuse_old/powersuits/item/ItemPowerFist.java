...
import net.machinemuse_old.numina.item.ModeChangingItem;
import net.machinemuse_old.powersuits.common.Config;
import net.machinemuse_old.powersuits.powermodule.tool.GrafterModule;
import net.machinemuse_old.powersuits.powermodule.tool.OmniWrenchModule;
import net.machinemuse_old.powersuits.powermodule.tool.RefinedStorageWirelessModule;
import net.machinemuse_old.powersuits.powermodule.weapon.MeleeAssistModule;
