...
import net.machinemuse_old.api.electricity.IMuseElectricItem;
import net.machinemuse_old.api.electricity.MuseElectricItem;
import net.machinemuse_old.numina.geometry.Colour;
import net.machinemuse_old.powersuits.powermodule.cosmetic.CosmeticGlowModule;
...
import static net.machinemuse_old.numina.general.MuseMathUtils.clampDouble;
