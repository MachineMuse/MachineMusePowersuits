...
import net.machinemuse_old.numina.event.NuminaPlayerTracker;
import net.machinemuse_old.numina.network.NuminaPackets;
...
public class CommonProxy {
    public void preInit(FMLPreInitializationEvent event) {
        ...
        File recipesFolder = new File(Numina.getInstance().configDir, "machinemuse_old/recipes");
