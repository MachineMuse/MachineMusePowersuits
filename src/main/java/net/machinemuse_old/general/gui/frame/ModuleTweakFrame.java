...
import net.machinemuse_old.general.gui.clickable.ClickableTinkerSlider;
...
import net.machinemuse_old.powersuits.network.packets.MusePacketTweakRequest;
import net.machinemuse_old.powersuits.powermodule.PowerModule;
import net.machinemuse_old.powersuits.powermodule.PropertyModifierLinearAdditive;
