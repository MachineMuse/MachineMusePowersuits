...
import net.machinemuse_old.powersuits.network.packets.MusePacketInstallModuleRequest;
import net.machinemuse_old.powersuits.network.packets.MusePacketSalvageModuleRequest;
