...
public class BlockLuxCapacitor extends BlockDirectional {
    ...
    public static final BlockLuxCapacitor instance = new BlockLuxCapacitor();
     ...
     * to set the rotation for the TileEntity which controls the rotation of the lens model.
     */
