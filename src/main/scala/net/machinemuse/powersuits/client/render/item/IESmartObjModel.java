...
//public class MPSCachedBakedModel extends OBJBakedModel implements IModelCustomData
//{
...
//    VertexFormat format;
//
//    public MPSCachedBakedModel(IBakedModel baseModel, OBJModel model, IModelState state, VertexFormat format, ImmutableMap<String, TextureAtlasSprite> textures, HashMap<TransformType, Matrix4> transformationMap)
//    {
...
//            if(!(originalModel instanceof MPSCachedBakedModel))
//                return originalModel;
//            MPSCachedBakedModel model = (MPSCachedBakedModel)originalModel;
//
...
//            MPSCachedBakedModel bakedModel = new MPSCachedBakedModel(model.baseModel, model.getModel(), model.getState(), model.getFormat(), builder.build(), transformationMap);
...
//            {
//                MPSCachedBakedModel model = null;
...
//                        model = new MPSCachedBakedModel(baseModel, getModel(), objstate, getFormat(), getTextures(), transformationMap);
//                    }
//                }
//                if(model==null)
//                    model = new MPSCachedBakedModel(baseModel, getModel(), this.getState(), getFormat(), getTextures(), transformationMap);
...
//    }
//
//    //	private final LoadingCache<Integer, MPSCachedBakedModel> ieobjcache = CacheBuilder.newBuilder().maximumSize(20).build(new CacheLoader<Integer, MPSCachedBakedModel>()
//    //	{
//    //		public MPSCachedBakedModel load(IModelState state) throws Exception
//    //		{
//    //			return new MPSCachedBakedModel(baseModel, getModel(), state, getFormat(), getTextures(), transformationMap);
//    //		}
//    //	});
//
