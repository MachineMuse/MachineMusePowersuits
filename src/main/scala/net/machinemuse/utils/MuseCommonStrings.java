...
public abstract class MuseCommonStrings {
    ...
    static {
        ...
        result.put(MuseHeatUtils.CURRENT_ENERGY(), StatCollector.translateToLocal("module.common.energy.current"));
        result.put(MuseHeatUtils.MAXIMUM_ENERGY(), StatCollector.translateToLocal("module.common.energy.maximum"));
