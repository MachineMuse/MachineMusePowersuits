...
public abstract class MuseRenderer {
    ...
    public static void drawRectPrism(double x, double d, double e, double f, double z, double g, float texturex, float texturey, float texturex2,
        ...
        new TexturedQuad(va1).draw(Tessellator.getInstance().getBuffer(), 1.0F);
        ...
        new TexturedQuad(va2).draw(Tessellator.getInstance().getBuffer(), 1.0F);
        ...
        new TexturedQuad(va3).draw(Tessellator.getInstance().getBuffer(), 1.0F);
        ...
        new TexturedQuad(va4).draw(Tessellator.getInstance().getBuffer(), 1.0F);
        ...
        new TexturedQuad(va5).draw(Tessellator.getInstance().getBuffer(), 1.0F);
        ...
        new TexturedQuad(va6).draw(Tessellator.getInstance().getBuffer(), 1.0F);
        // int[] indices = {
        // 0, 3, 1,
        // 0, 2, 3,
        // 2, 6, 7,
