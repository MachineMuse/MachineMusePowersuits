...
public class RenderBlinkDriveBolt extends Render {
	...
	public RenderBlinkDriveBolt() {
		Colour c1 = new Colour(.4, .8, .6, 0.3);
		circle1 = new DrawableMuseCircle(c1, c1);
		c1 = new Colour(.4, .8, .6, 0.6);
		circle2 = new DrawableMuseCircle(c1, c1);
		c1 = new Colour(.4, .8, .6, 1);
	...
	public void doRender(Entity entity, double x, double y, double z, float yaw, float partialTickTime) {
		EntityBlinkDriveBolt bolt = (EntityBlinkDriveBolt) entity;
