...
public class ModuleManager {
	...
	protected static final List<IOnItemUseModule> onItemUseModules = new ArrayList();
	...
	public static void addModule(IPowerModule module) {
		...
		if (module instanceof IOnItemUseModule) {
			onItemUseModules.add((IOnItemUseModule) module);
		}
	}
	...
	public static List<IOnItemUseModule> getOnItemUseModules() {
		return onItemUseModules;
	}
}
