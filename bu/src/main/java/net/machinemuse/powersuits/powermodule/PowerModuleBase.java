...
public abstract class ItemAbstractPowerModule implements IPowerModule {
    ...
    public ItemAbstractPowerModule(String dataNameIn, EnumModuleTarget moduleTargetIn) {
    ...
    public ItemAbstractPowerModule(EnumModuleTarget moduleTargetIn) {
        this.moduleTarget = moduleTargetIn;
        this.propertyModifiers = new HashMap();
        this.defaultTag = new NBTTagCompound();
        this.defaultTag.setBoolean(TAG_ONLINE, true);
...
//    }
    ...
    public boolean equals(ItemAbstractPowerModule other) {
